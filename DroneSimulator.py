        ...
        for t in range(self.simulation_length):
            ...
            if self.test_thrust:
                ...
                if self.test_integral:
                    ...
                    thrust, data_thrust = pid_thrust(self.target_elevation[t], drone.get_elevation(), thrust_params['tau_p'], thrust_params['tau_d'], thrust_params['tau_i'], data_thrust)
            ...
            if self.test_roll:
                ...
                #elif self.supply_params:
                roll, data_roll = pid_roll(self.target_x[t], drone.get_x_coord(), roll_params['tau_p'], roll_params['tau_d'], roll_params['tau_i'], data_roll)
                data_roll['prev_roll'] = roll
                #if roll_params.get('tau_i', 0) != 0:
                #if (drone.roll_angle == drone.MAX_ROLL_ANGLE and roll > 0) or \
                #   (drone.roll_angle == -drone.MAX_ROLL_ANGLE  and roll < 0):
